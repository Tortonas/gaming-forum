...
<html lang="en">
  ...
  <body>
    ...
    <div class='container'>
        ...
        <h2> <a href="viewtheme.php">Random tema</a><!-- <button class="btn btn-danger btn-sm">Naikinti</button>--></h2>
        <h2> <a href="viewtheme.php">Random tema</a><!-- <button class="btn btn-danger btn-sm">Naikinti</button>--></h2>
        <h2> <a href="viewtheme.php">Random tema</a><!-- <button class="btn btn-danger btn-sm">Naikinti</button>--></h2>
        <h2> <a href="viewtheme.php">Random tema</a><!-- <button class="btn btn-danger btn-sm">Naikinti</button>--></h2>
        <h2> <a href="viewtheme.php">Random tema</a><!-- <button class="btn btn-danger btn-sm">Naikinti</button>--></h2>

        <a href="createtheme.php"> <button type="button" class="btn btn-primary">Sukurti naują temą</button> </a>
    </div>
    <!-- Optional JavaScript -->
